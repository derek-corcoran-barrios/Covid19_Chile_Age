...
* Resultados preeliminares dicen que cuanto mas temprano empieze la cuarentena nacional es mejor
* Esto beneficiará más a las comunas que no han tenido cuarentenas
* Antes del peak la probabilidad de que que haya no hayan infectados, expuestos o asintomaticos en una casa bajan en el tiempo $CH_{i(t)}$

## Necesidades

* Transparencia en los datos por comuna
* Entrega de datos de Recuperados, Fallecidos, etc por comuna
* En un mundo ideal, generacion de API para acceder a datos

## Recursos

* Repositorio (github)[https://github.com/derek-corcoran-barrios/Covid19_Chile_Age0] con los modelos y bases de datos
